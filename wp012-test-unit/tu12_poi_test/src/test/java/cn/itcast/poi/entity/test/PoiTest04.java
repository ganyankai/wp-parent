...
public class PoiTest04 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //读取图片流
        FileInputStream stream = new FileInputStream("C:\\Users\\admin\\Desktop\\test\\t01\\logo.jpg");
        //转化二进制数组
        ...
        //3.文件流
        FileOutputStream fos = new FileOutputStream("C:\\Users\\admin\\Desktop\\test\\t01\\test4.xlsx");
