...
public class PoiTest05 {
    public static void main(String[] args) throws IOException {
        //1.根据Excel文件创建工作簿
//        Workbook wb = new XSSFWorkbook("C:\\Users\\admin\\Desktop\\test\\t01\\demo.xlsx");
        Workbook wb = new XSSFWorkbook("C:\\Users\\admin\\Desktop\\test\\t01\\baiwan\\demo.xlsx");
        //2.获取Sheet
        Sheet sheet = wb.getSheetAt(0);//参数：索引

        //3.获取Sheet中的每一行，和每一个单元格
        for(int rowNum =0;rowNum<=sheet.getLastRowNum();rowNum++){
            Row row = sheet.getRow(rowNum);//根据索引获取每一行的内容
