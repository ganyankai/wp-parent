package cn.puc.uas.system.controller;

import cn.puc.uas.common.controller.BaseController;
import cn.puc.uas.common.entity.PageResult;
import cn.puc.uas.common.entity.Result;
import cn.puc.uas.common.entity.ResultCode;
import cn.puc.uas.domain.system.Role;
import cn.puc.uas.domain.system.response.RoleResult;
import cn.puc.uas.system.service.RoleService;
...
//        Page<Role> searchPage = roleService.findByPage(companyId, page, pagesize);
        Page<Role> searchPage = roleService.findByPage("1", page, pagesize);
