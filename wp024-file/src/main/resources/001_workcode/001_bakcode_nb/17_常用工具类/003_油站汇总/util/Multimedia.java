...
import com.catt.common.util.image.ImgHandler;
import com.catt.common.util.image.JavaImgHandler;
...
public abstract class Multimedia {
	 ...
	 * 所有支持的视频MIME TYPES
	 */
	public final static String[] VIDEO_EXTS = new String[] {"avi", "rm", "3gp", "wmv", "mpg", "asf", "mp4", "mov"};
	 ...
	 * @throws IOException
	 */
	public static void saveImage(File img, String dest, int top, int left,
