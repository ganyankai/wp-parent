...
public class StringUtil extends StringUtils {
    ...
    public static String getIpAddr(HttpServletRequest request) {
        ...
        if (com.catt.common.util.lang.StringUtil.isBlank(ip) || UNKNOWN.equalsIgnoreCase(ip)) {
        ...
        if (com.catt.common.util.lang.StringUtil.isNotBlank(ip)
                && (ip.contains("127.0.0.1") || ip.contains("0:0:0:0:0:0:0:1") || ip.contains("localhost"))) {
            String localIp = com.catt.common.util.lang.StringUtil.getIPAddress();
            if(com.catt.common.util.lang.StringUtil.isNotBlank(localIp)){
                ip = localIp;
            }
        }
    ...
    public static String doLikeEscape(String s) {
        if (com.catt.common.util.lang.StringUtil.checkStr(s)) {
    ...
    private static String getIPOnWindows() throws Exception{
        ...
        try {
            ...
            if(!com.catt.common.util.lang.StringUtil.checkStr(ip)){
