...
public class RequestUtil {
	...
	public static Map getMapByRequest(HttpServletRequest request) {
		...
		if (com.catt.common.util.lang.StringUtil.checkObj(request.getAttribute("sUrl"))) {
	...
	public static String getIpAddr(HttpServletRequest request) {
		...
		if (ip != null && (ip.indexOf("127.0.0.1") >= 0 || ip.indexOf("0:0:0:0:0:0:0:1") >= 0
			...
			ip = com.catt.common.util.lang.StringUtil.getIPAddress();
		}
		return ip;
	}
	...
	public static String getRealPath(HttpServletRequest request){
		String realPath = com.catt.common.util.RequestUtil.getRealPath(request.getSession().getServletContext());
		return realPath;
	}
	...
	public static boolean compareURL(String targetUrl, String comparedUrl,
		...
		if (!(com.catt.common.util.lang.StringUtil.checkStr(targetUrl) && com.catt.common.util.lang.StringUtil
