...
public abstract class ExcelBean {
	 ...
	 * @throws IOException
	 */
	public static com.catt.common.util.excel.ExcelBean create(String filePath)
	 ...
	 * @throws IOException
	 */
	public static com.catt.common.util.excel.ExcelBean create(File file) throws InvalidFormatException,
			IOException {
	 ...
	 * @throws IOException
	 */
	public static com.catt.common.util.excel.ExcelBean create(InputStream inputStream)
			throws InvalidFormatException, IOException {
	 ...
	 * @return
	 */
	public com.catt.common.util.excel.SheetBean getSheetBean(String name) {
	 ...
	 * @return
	 */
	public com.catt.common.util.excel.SheetBean getSheetBean(int index) {
	 ...
	 * @return
	 */
	public com.catt.common.util.excel.SheetBean getSheetBean(Sheet sheet) {
		if (sheet == null) {
			return null;
		}
		return new com.catt.common.util.excel.SheetBean(this, sheet);
	}
	 ...
	 * @return
	 */
	public com.catt.common.util.excel.SheetBean createSheetBean() {
	 ...
	 * @return
	 */
	public com.catt.common.util.excel.SheetBean createSheetBean(String name) {
	 ...
	 * @return
	 */
	public com.catt.common.util.excel.SheetBean getOrCreateSheetBean(String name) {
		Sheet sheet = workbook.getSheet(name);
		if (sheet == null) {
	...
	public int createPagingSheetWithData(String sheetName,
		...
		for (int i = 0; i < page; i++) {
			com.catt.common.util.excel.SheetBean sheetBean = getOrCreateSheetBean(sheetName + "_"
					+ (i + 1));
