...
public class BaseRuntimeException extends RuntimeException {
	...
	private void keepTheSourceException(Throwable cause){
		...
		if (cause != null && (cause instanceof com.catt.common.util.BaseRuntimeException)) {
			com.catt.common.util.BaseRuntimeException c = (com.catt.common.util.BaseRuntimeException)cause;
			this.cause = c.cause;
			this.mArgs = c.mArgs;
		} else {//否则直接记录
			this.cause = cause;
	...
	/**多层抛异常，测试构造方法是否能传承自定义异常描述和原始异常对象*/
	 public static void main(String[] args) {
		...
		com.catt.common.util.BaseRuntimeException b1 = new com.catt.common.util.BaseRuntimeException(e, m1);
		
		Map m2 = new HashMap<String, String>();
		m2.put("path", "d/e/f/");
		m2.put("msg", "my message2");
		
		com.catt.common.util.BaseRuntimeException b2 = new com.catt.common.util.BaseRuntimeException(b1, m2);
		
		Map m3 = new HashMap<String, String>();
		m3.put("path", "h/i/j/k/");
		m3.put("msg", "my message3");
		
		com.catt.common.util.BaseRuntimeException b3 = new com.catt.common.util.BaseRuntimeException(b2, m3);
